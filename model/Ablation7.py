...
from model.LFT_my import AltFilter as LFT_AltFilter
...
class Fusion_Block(nn.Module):
    def __init__(self, args, hidden_dim):
        ...
        self.model_type = 'LFT_and_EPIConv'  # 'LF_former_and_SAS', 'LF_former_and_SAV', 'EPIT_and_EPIConv', 'LFT_and_EPIConv', 'proposed'
