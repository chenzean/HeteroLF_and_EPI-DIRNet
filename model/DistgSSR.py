...
class get_model(nn.Module):
    def __init__(self, args):
        ...
        self.init_conv = nn.Conv2d(3, channels, kernel_size=3, stride=1, dilation=self.angRes, padding=self.angRes, bias=False)
    ...
    def forward(self, x, info=None):
        ...
        out = self.upsample(buffer_SAI) + x
        return out
